...
class OurTrainingArguments(TrainingArguments):
    ...
    use_smooth_trainer: bool = field(
        default=False,
        metadata={'help': 'use smooth contrastive trainer'}
    )
        
    smoothing_momentum: float = field(
        default=0.99,
        metadata={'help': 'Momemtum of updating encoder. Only used when `use_smooth_trainer` is True.'}
    )
