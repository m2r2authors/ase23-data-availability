...
from trainers import CLTrainer, SmoothCLTrainer
...
def main():
    ...
    assert model_args.model_name_or_path
    if training_args.use_smooth_trainer and not('Salesforce' in model_args.model_name_or_path):
        rename_and_save_params(model_args.model_name_or_path)
    ...
    if training_args.use_smooth_trainer:
        trainer = SmoothCLTrainer(
            model=model,
            args=training_args,
